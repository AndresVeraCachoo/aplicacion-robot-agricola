...
const authService = new AuthService(prisma, env.JWT_SECRET);
 ...
 * tags:
 *   name: Autenticación
 *   description: Endpoints para el inicio de sesión y verificación de sesión
*/
 ...
 *       400:
 *         description: Credenciales incompletas o error de formato.
 *       401:
